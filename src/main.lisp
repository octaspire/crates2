...
(defparameter *level-updatables-addlist* nil)
(defparameter *level-updatables-removelist* nil)
...
(defun add-updatable (crate)
  (unless (or (find crate *level-updatables*)
              (find crate *level-updatables-addlist*)
              (find crate *level-updatables-removelist*))
    (setf *level-updatables-addlist* (cons crate *level-updatables-addlist*))))

(defun remove-updatable (crate)
  (unless (find crate *level-updatables-removelist*)
    (setf *level-updatables-removelist* (cons crate *level-updatables-removelist*))))
