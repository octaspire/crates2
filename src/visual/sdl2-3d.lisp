...
(defun ui-render (level step)
  (sb-int:with-float-traps-masked (:invalid :inexact :overflow)
    ...
    (cffi:with-foreign-objects ((rect1 '(:struct sdl-rect))
      ...
      (enter-ortho)
      (glbegin +GL-QUADS+)
      (gltexcoord2d 0.0d0 1.0d0) (glvertex3f 0.0    0.0    0.0)
      (gltexcoord2d 1.0d0 1.0d0) (glvertex3f 200.0  0.0    0.0)
      (gltexcoord2d 1.0d0 0.0d0) (glvertex3f 200.0  200.0  0.0)
      (gltexcoord2d 0.0d0 0.0d0) (glvertex3f 0.0    200.0  0.0)
      (glend)
      (leave-ortho)
