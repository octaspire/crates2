...
(defun init-visual-hash ()
  ...
  ;; TURNSTILE
  (setf (gethash "turnstile-e1" *visual-hash*) (make-rect 0))
  (setf (gethash "turnstile-w1" *visual-hash*)(make-rect 0))
  (setf (gethash "turnstile-n1" *visual-hash*) (make-rect 0))
  (setf (gethash "turnstile-s1" *visual-hash*) (make-rect 0))
  (setf (gethash "turnstile-e" *visual-hash*) (make-rect 0))
  (setf (gethash "turnstile-w" *visual-hash*)(make-rect 0))
  (setf (gethash "turnstile-n" *visual-hash*) (make-rect 0))
  (setf (gethash "turnstile-s" *visual-hash*) (make-rect 0))
  ;; BLOCK-COUNTER
